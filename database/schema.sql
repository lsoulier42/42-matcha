...
CREATE TABLE IF NOT EXISTS users (
    ...
    genre            ENUM('homme','femme','non-binaire','agenre','xénogenre','genre-fluide','autre') NULL,
    orientation      ENUM('hetero','homo','gay','lesbienne','bi','pan','asexuel','demisexuel','questionnement','autre') NULL,
    bio              TEXT             NULL,
    birthdate        DATE             NULL,
